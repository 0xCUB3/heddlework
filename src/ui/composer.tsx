    ...
    >
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 768, paddingBottom: 32, overflow: 'visible' }}>
        ...
        <textarea
          ...
          placeholder={connected ? (draft ? (layout.mobile ? 'Ask anything, or / for commands' : 'Ask anything, or type / for commands and skills') : 'Ask for follow-up changes or attach images') : state.activity === 'Opening thread' ? 'Opening thread…' : 'Reconnect to Pi to begin'}
          minRows={3}
          maxRows={7}
          autoFocus
          readOnly={!connected}
